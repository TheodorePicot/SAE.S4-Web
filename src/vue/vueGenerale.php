...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark  mx-4 fs-5">
        <a href="<?= $generateurUrl->generate("plusCourtChemin"); ?>">
            <svg width="150px" height="50px" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= $generateurUrl->generate("plusCourtChemin"); ?>">Itinéraire</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ms-auto">
                <?php if (true) : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $generateurUrl->generate("afficherFormulaireCreation"); ?>">S'inscrire</a>
                    </li>
                <?php else : ?>
                    <li class="nav-item">
                        <a class="nav-link"
