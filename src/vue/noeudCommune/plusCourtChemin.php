<div class=" container-fluid my-5">
    <div class="container-fluid d-flex justify-content-center">
        <form action="<?= $generateurUrl->generate("plusCourtChemin"); ?>" method="post">
            <fieldset>
                ...
                <div class="my-5">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 acdiv">
                            <input name="nomCommuneDepart" type="text" class="form-control" id="nomCommuneDepart_id" autocomplete="off"
                                   placeholder="Ex : Menton">
                    ...
                    <div class="form-group row my-4">
                        ...
                        <div class="col-sm-10 acdiv">
                            <input name="nomCommuneArrivee" type="text" class="form-control" id="nomCommuneArrivee_id" autocomplete="off"
                                   placeholder="Ex : Porspoder">
